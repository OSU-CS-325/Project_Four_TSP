...
Our research included Google searches regarding TSP algorithms, and readings of various texts such as ~\cite{cormen/2009} and ~\cite{skiena/2008}.  See the bibliography at the conclusion of this report for a full list of references.  Ultimately, we implemented four different algorithms in Python or C.  We will call these algorithms: braindead tour, nearest neighbor, depth first search of the minimum spanning tree, and 2-opt.  Details and pseudocode for each implementation can be found in the following pages.

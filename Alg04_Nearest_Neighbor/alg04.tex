...
This algorithm starts the salesman at a random city in the tour and repeatedly visits the nearest city until all have been visited. We implemented this algorithm in Python 3.5. We researched the algorithm both on Wikipedia \url{https://en.wikipedia.org/wiki/Nearest_neighbour_algorithm} and by referring to the book ~\cite{skiena/2008}. and a summary of the research performed. I'd like to recommend we use BibTeX here to keep track of our sources, and make referencing easy. In the report directory, you'll find a \verb|report.bib| file. In that file, you can add your sources. Then to cite a source, you use the \verb|\cite{citationName}| command. Check out the section titled ``3 Bibliography management with Bibtex" in the referenced website to see how it works. \cite{bibtex} References appear at the end of the report PDF.

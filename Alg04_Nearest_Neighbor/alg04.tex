...
This algorithm starts the salesman at a random city in the tour and repeatedly visits the nearest city until all have been visited. We implemented this algorithm in Python 3.5. We researched the algorithm both on Wikipedia \url{https://en.wikipedia.org/wiki/Nearest_neighbour_algorithm} and by referring to The Algorithm Design Manual ~\cite{skiena/2008}.
